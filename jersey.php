...
<body>
  <div class="container">
  	<div class="navbar">
		...
		<table>
			<tr>
				<td><img src="Images/psg3.png" align="left" alt="jordan" id="mainImage" width="88%"></td>
			
				<td>
					<div class="itemdetail">
						<form method="POST" action="" >
							<h1 name="ItemName">PSG 2021/2022 Third Jersey</h1>
							<p>The PSG 20-21 third jersey brings a very classy design, combining a bordeaux base with truly gold for accents and logos. </p>
							<h4 name="Price">Rs.25000</h4>
							
						<br>
							
							
						</form>
						<button class="butt" name="ATC" onclick="window.location.href='addToCart.php?ItemId=49'">Add To Cart</button>
			...
			<tr>
				<td>
					<div class="small_imgs">
						<img src="Images/psgmin1.jpg" class="minImage" id="minImage1" width="35%" height="80px" onclick="enLarge('minImage1')">
						<img src="Images/psgmin2.jpg" class="minImage" id="minImage2" width="80px" onclick="enLarge('minImage2')">
						<img src="Images/psg3.png" class="minImage" id="minImage3" width="30%" onclick="enLarge('minImage3')">
					</div>
				</td>
				<td></td>
				<td><div id="Warranty">
        ...
        <table class="t1" width="100%">
          ...
          <tr>
            ...
            <td style="border-right: solid 1px grey; border-left: solid 1px grey;">
             ...
             <li><a href="https://www.sarasavi.lk/">Sarasavi</a></li>f
