...
<body>
  <div class="container">
  	<div class="navbar">
		...
		<table>
			<tr>
				<td><img src="Images/grain.jpg" align="left" alt="jordan" id="mainImage" width="88%"></td>
			
				<td>
					<div class="itemdetail">
						<form method="POST" action="" >
							<h1 name="ItemName">Nutri Grain</h1>
							<p> Delicious mix of your favourite breakfast ingredients all wrapped up in a satisfying bar.</p>
							<h4 name="Price">Rs.380</h4>
						
						<br>
							
							
						</form>
						<button class="butt" name="ATC" onclick="window.location.href='addToCart.php?ItemId=50'">Add To Cart</button>
			...
			<tr>
				<td>
					<div class="small_imgs">
						<img src="Images/grain2.jpg" class="minImage" id="minImage1" width="30%" onclick="enLarge('minImage1')">
						<img src="Images/grain.jpg" class="minImage" id="minImage2" width="30%" onclick="enLarge('minImage2')">
						<img src="Images/grain1.jpg" class="minImage" id="minImage3" width="30%" onclick="enLarge('minImage3')">
					</div>
				</td>
				<td></td>
				<td><div id="Warranty">
