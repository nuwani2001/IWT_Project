...
<?php 
        ...
        $sql = "SELECT * From requestseller WHERE username = '$userN'";
...
<center>
<h3>Seller Request Form</h3></center>
			...
			<form method="POST" action="#" class="form1">
				...
				<select name="category"><br>
					...
					<option>Pharmacutical</option>
					<option>Books</option>
				</select>
				<br><br>
				Experience as a seller :<br>
...
if(isset($_POST['submit'])){
	...
	$toAdmin="INSERT INTO `requestseller`(`requestNo`, `firstName`, `lastName`, `category`, `experience`, `username`, `mobile`, `email`, `status`) VALUES ('','$firstname','$lastname','$category','$exp','$uname','$mobile','$email','Pending')";


	if(mysqli_query($conn,$toAdmin)){
		  header("Refresh: 0.5;URL = index.php");
			echo "<script>alert('Seller Request Form Successfully Submited.')</script>";
