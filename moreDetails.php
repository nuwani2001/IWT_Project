...
<head>
	<meta charset="utf-8">
	<title><?php echo $row["ItemName"]?>| eZBuy | Online Shopping Mall</title>
...
<body>
  ...
  <div class="container">
  	<div class="navbar">
		...
		<table>
			<tr>
				<td><img src="<?php echo $row["pic"]?>" align="left" alt="jordan" id="mainImage" width="88%"></td>
			
				<td>
					<div class="itemdetail">
						<form method="POST" action="" >
							<h1 name="ItemName"><?php echo $row["ItemName"]?></h1>
							<p><?php echo $row["ItemDescription"]?></p>
							<h4 name="Price">Rs.<?php echo$row["Price"]?></h4>
							
							
							
						</form><button class="butt" name="ATC" onclick="window.location.href='addToCart.php?ItemId=<?php echo $row["ItemId"]?>'">Add To Cart</button>
...
?>
				...
				<td>
					 ...
					 <table>
						...
						<tr>
							<td class="reco"><a href="moreDetails.php? ItemName='<?php echo $row['ItemName'];?>'"><img src="<?php echo $row["pic"]?>" id="reco1" ></a></td>
						</tr>	
				...
				<td>
					<table>
						...
						<tr>
							...
							<td class="reco"><?php echo $row["ItemName"]?></td>
						</tr>
						<tr>
